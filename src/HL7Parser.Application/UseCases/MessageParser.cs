// <copyright file="MessageParser.cs" company="Christopher Wenzlick">
...
/// <summary>
/// Parses a raw HL7 v2 message string into a <see cref="Message"/> by delegating to <see cref="Message.Create"/>.
/// </summary>
public sealed class MessageParser : IMessageParser
{
    ...
    /// </returns>
    public Result<Message> Execute(string rawMessage)
    {
        ...
        return Message.Create(rawMessage);
    }
}
